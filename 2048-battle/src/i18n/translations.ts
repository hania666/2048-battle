export const translations = {
  ...
  es: {
    ...
    medium: '🟡 MEDIO',
    dailyTasks: 'TAREAS DIARIAS', settings: 'AJUSTES', audioFeedback: 'AUDIO', backgroundMusic: 'Musica de fondo', musicSub: 'Musica durante el juego', soundEffects: 'Efectos de sonido', soundSub: 'Sonidos', vibration: 'Vibracion', vibrationSub: 'Feedback haptico', language: 'Idioma', about: 'ACERCA DE', version: 'Version 1.0.0', privacyPolicy: 'Privacidad', privacyPolicySub: 'Tus datos', profile: 'PERFIL', achievements: 'LOGROS', matchHistory: 'HISTORIAL', noMatches: 'Sin partidas', noMatchesSub: 'Juega una partida!', gamesLabel: 'PARTIDAS', winsLabel: 'VICTORIAS', winRateLabel: 'VICTORIAS %', streakLabel: 'RACHA', tileSkins: 'Skins', back: 'ATRAS', newGame: 'NUEVO JUEGO', tryAgain: 'INTENTAR', gameOver: 'Fin del juego!', score: 'PUNTOS', best: 'RECORD',
  ...
  fr: {
    ...
    dailyTasks: "TACHES DU JOUR", settings: "PARAMETRES", audioFeedback: "AUDIO ET RETOUR",
